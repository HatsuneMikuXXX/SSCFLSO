...
void SemiLagrangianRelaxation::solve(const SSCFLSO& instance, facility_vector& current_best, const std::chrono::milliseconds& time_limit) {
...
SLR_solution_and_subgradient SemiLagrangianRelaxation::SLR(const SSCFLSO& instance, const semilagrange_multipliers& multipliers) {
	SLR_solution_and_subgradient res;
